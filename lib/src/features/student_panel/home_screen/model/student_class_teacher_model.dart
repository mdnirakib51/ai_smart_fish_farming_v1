class StudentClassTeacherModel {
  Organization? organization;
  Section? section;
  ClassTeacher? classTeacher;
  List<AllTeachers>? allTeachers;

  StudentClassTeacherModel(
      {this.organization, this.section, this.classTeacher, this.allTeachers});

  StudentClassTeacherModel.fromJson(Map<String, dynamic> json) {
    ...
    classTeacher = json['class_teacher'] != null
        ...
        : null;
    if (json['all_teachers'] != null) {
      allTeachers = <AllTeachers>[];
      json['all_teachers'].forEach((v) {
        allTeachers!.add(AllTeachers.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (allTeachers != null) {
      data['all_teachers'] = allTeachers!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class Organization {
  ...
  Organization({this.name, this.address});
...
class Section {
  ...
  Section({this.id, this.name, this.className});
...
class ClassTeacher {
  ...
  ClassTeacher({this.id, this.name, this.email, this.phone, this.photo});
