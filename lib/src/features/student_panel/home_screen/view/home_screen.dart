      ...
      onTap: () async {
        switch (menuItem?[index].slug ?? "") {
          case 'pond_a':
            ...
            break;
          case 'pond_b':
            showCustomSnackBar("Pond B is under development");
            break;
          case 'pond_c':
            showCustomSnackBar("Pond C is under development");
            break;
          default:
            showCustomSnackBar("The Menu is currently under development");
        }
      },
      child: Container(
        width: double.infinity,
...
class GraphPainter extends CustomPainter {
  ...
  GraphPainter({required this.color, this.isDanger = false});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Create wave pattern
    final points = isDanger
        ? [0.6, 0.4, 0.5, 0.3, 0.45, 0.35, 0.4, 0.5, 0.6]
        : [0.5, 0.3, 0.4, 0.2, 0.3, 0.15, 0.2, 0.1, 0.05];
