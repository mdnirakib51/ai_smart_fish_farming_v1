...
class StudentAssignmentsWidget extends StatefulWidget {
  ...
  @override
  State<StudentAssignmentsWidget> createState() => _StudentAssignmentsWidgetState();
}

class _StudentAssignmentsWidgetState extends State<StudentAssignmentsWidget> {
  ...
  Widget build(BuildContext context) {
    final selectedColor = widget.color ??
        (widget.itemCount != null
            ? StudentAssignmentsWidget.colorList[(widget.itemCount! - 1) % StudentAssignmentsWidget.colorList.length]
            : ColorRes.appColor);
